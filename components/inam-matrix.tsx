  ...
  return (
    <div className="space-y-2">
      <p className="px-1 text-xs text-muted-foreground">
        Solid labels directly meet a need.{" "}
        <span className="opacity-70">
          ↳ Faded labels are upstream dependencies.
        </span>
      </p>
        ...
        <table className="w-full min-w-[640px] border-separate border-spacing-0 text-sm">
          <thead>
            <tr>
              <th
                scope="col"
                className="sticky left-0 z-20 border-b bg-card p-3 text-left align-bottom"
              >
            ...
            {matrix.groups.map((group) => (
              <Fragment key={group.tier}>
                <tr>
                  <th
                    scope="colgroup"
                    colSpan={matrix.layers.length + 1}
