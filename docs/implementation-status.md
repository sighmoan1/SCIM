...
Cell notes are therefore canonical-JSON-only in 0.5.0.
...
The primary Map and Review routes share browser-local accepted state.
...
It does not yet prove the capability matrix above. Tests should be added for every listed gap before closing it.
